...
- Discussions and review threads paginate. `?per_page=100` is not the whole story on a long-running PR — follow the pages before concluding "no open threads" or "never reviewed". A PR carrying a hundred-plus discussions is not exotic.
