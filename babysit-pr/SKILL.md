...
- **Merged or closed.**
- **Time cap** — about 2 hours have passed since you started watching (roughly two dozen rounds). Stop even if it isn't approved, say so, and let the user re-run to keep watching.
