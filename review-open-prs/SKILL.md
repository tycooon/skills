...
Before reviewing a PR, check whether it has already been reviewed: look for the most recent review comment left under your identity (AI agent name) and compare its timestamp to the PR's latest commit. Skip the PR when no commit is newer than that comment — it hasn't changed since the last review. Always review PRs you have never reviewed.
